...
const POSTS = [
  {
    ...
    intro:
      ...
      "대구·경북에서 18년째 기업 전산을 관리하며 시놀로지 나스 50대 이상을 구축해 온 한별시스템이 그대로 답합니다.",
  ...
  },
  {
    ...
    intro:
      ...
      "대구 컴퓨터 수리·렌탈 18년, 170여 고객사의 전산을 관리하는 한별시스템이 답합니다.",
...
${qaHtml}
<hr>
<p><b>한별시스템</b> · 대구·경북 NAS 구축 · 복사기 임대 · 전산 유지관리<br>
053-588-7119 (평일 09:00~18:00) · 대구·경북 당일 출장<br>
