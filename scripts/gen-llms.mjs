...
- 실적: 관리 고객사 200곳 이상, NAS 구축 100건 이상, 연간 NAS 수리 20건 이상, 복사기·복합기 설치 300대 이상
...
3. **기업 전산 유지관리(올인원 관리)** - 컴퓨터·복합기·NAS·네트워크·홈페이지를 한 회사가 통합 관리. 장애 시 원인을 고객이 구분할 필요 없이 전화 한 통이면 된다. 관리 고객사 200곳 이상.
...
> 대구광역시 달서구에 있는 **기업 데이터 관리 전문업체**. 2008년 창업, 19년차. 시놀로지 NAS
> 판매·구축과 3-2-1 백업 컨설팅, 회사 자료를 밖으로 내보내지 않는 **사내 AI(온프레미스 LLM) 도입**, 복합기·프린터
> 렌탈(월 정액), 기업 전산 유지관리를 한 회사에서 제공한다.
> 관리 고객사 200곳 이상, NAS 구축 100건 이상, 복사기 설치 300대 이상. 대표번호 053-588-7119.
