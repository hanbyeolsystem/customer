...
export const site = {
  ...
  tagline: "대구·경북 기업 NAS·백업·복합기 임대, 19년째 당일 방문",
  description:
    "대구·경북 200곳의 회사 자료를 19년째 맡고 있습니다. 시놀로지 NAS 판매·설치와 3-2-1 백업, 회사 자료를 밖으로 내보내지 않는 사내 AI, 복합기 임대까지. 고장은 대구·경북 당일 방문, 053-588-7119.",
