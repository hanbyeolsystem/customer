...
export const caseStudies: CaseStudy[] = [
  // ───────────────────────── NAS · 서버 구축 ─────────────────────────
  {
    ...
    summary:
      "인원이 많고 자료가 쌓일 대로 쌓인 사무실. 기존 NAS의 데이터를 새 NAS로 옮겨 서버를 다시 세운 현장.",
    ...
    challenge:
      "회사 규모가 크고 인원이 많아 데이터 양 자체가 많았습니다. 자료를 분류하고 백업한 뒤 서버를 새로 세워야 했는데, 옮기다 자료가 유실되면 업무가 멈추는 상황. 사내에서 직접 손대기 어렵다고 문의를 주셨습니다.",
    solution: [
  ...
  },
  {
    ...
    summary:
      "나스가 처음이라 무엇부터 해야 할지 모르겠다는 예천 소규모 사무실. DS925+로 서버를 세우고 관리까지 이어받은 현장.",
    ...
    challenge:
      "나스가 좋다는 말은 들었지만 어떤 모델을 골라야 할지 몰랐습니다. 설치 후 관리를 누가 할지 아는 사람도 사무실에 없는 상태. 설치만 해 놓고 방치되면 하드디스크가 노후해 데이터가 날아갈 수 있어 관리까지 맡길 곳을 찾고 계셨습니다.",
    solution: [
    ...
    result:
      "설치와 초기 설정, 교육까지 한 번의 방문으로 마쳤습니다. 이후 하드디스크 상태와 백업이 정상인지 정기적으로 점검하고 있습니다.",
    spec: [
  ...
  },
  {
    ...
    summary:
      "어울아트센터 옆 행복북구문화재단. 자료를 모아 두고 내부에서 공유할 수 있도록 DS925+ 서버를 설치한 현장.",
    gear: ["Synology DS925+"],
    ...
    challenge:
      "내부 인원 이동이 많고 다루는 자료의 종류도 여러 가지였습니다. 자료를 한곳에 저장하고 필요한 사람끼리 공유할 수 있는 구조가 필요했습니다. 저장 용량도 넉넉하게 잡아 둬야 하는 조건.",
    solution: [
  ...
  },
  {
    ...
    summary:
      "도면과 설계 자료가 계속 쌓이는 건축사무소. 베이 수를 넉넉히 확보한 DS1825+로 대용량 서버를 구축한 현장.",
    ...
    challenge:
      "사무실 규모가 어느 정도 있고 도면 자료가 계속 늘어나는 구조였습니다. 충분한 용량의 서버를 구축해 자료를 한곳에 보관하고 싶다는 문의. 랙마운트까지 갈 필요는 없지만 베이 수는 확보해야 하는 조건이었습니다.",
    solution: [
    ...
    result:
      "도면과 설계 자료를 한곳에 모았습니다. 용량이 부족해지면 남은 베이에 디스크를 추가해 확장할 수 있는 구조로 마무리했습니다.",
    spec: [
  ...
  },
  {
    ...
    summary:
      "사무실을 새로 꾸리며 PC와 함께 서버가 필요했던 성운대학교. 랙마운트 RS2421+로 기업급 서버를 구축한 현장.",
    ...
    challenge:
      "새 사무실을 꾸리면서 PC와 NAS를 함께 설치해야 했습니다. 보관할 자료의 종류가 여러 가지고 양도 많았습니다. 일반 데스크형 DS 제품으로는 성능과 용량이 부족할 수 있는 조건.",
    solution: [
  ...
  },
  {
    ...
    result:
      "디스크 한 개가 고장 나도 데이터가 유지되는 RAID 5 구성으로 마무리했습니다. 이후 서버 관리까지 이어서 맡고 있습니다.",
    spec: [
      { label: "본체", value: "DS925+" },
  ...
  },
  {
    ...
    challenge:
      "서버를 두는 장소가 두 곳이었고 각각 쓰임이 달랐습니다. 자료가 많고 복잡한 활용이 필요하면 랙마운트가 맞습니다. 단순 백업 용도라면 데스크형이 비용 대비 낫고요. 그래서 한 모델로 통일할 수 없는 조건이었습니다.",
    solution: [
  ...
  },
  {
    ...
    challenge:
      "용량을 얼마나 잡아야 하는지부터 감이 오지 않는 상태였습니다. 대충 세팅하면 RAID 기능을 제대로 쓰지 못하고 나중에 다시 손봐야 합니다. 그래서 처음부터 제대로 잡아 줄 곳이 필요했습니다.",
    solution: [
  ...
  },
  {
    ...
    challenge:
      "외형 파손이 아니라 내부 디스크가 손상된 상태였고, 오래 사용해 생긴 문제로 보였습니다. 데이터를 되살리는 것과 새 장비로 옮기는 것을 같이 해야 하는 일. 직접 하기는 어렵다고 판단해 문의를 주셨습니다.",
    solution: [
  ...
  // ───────────────────────── 복합기 · 프린터 ─────────────────────────
  {
    ...
    summary:
      "인쇄 속도를 중요하게 보신 사무실. TASKalfa 3011i(흑백)와 3552ci(컬러) 두 대를 동선에 맞춰 설치한 현장.",
    ...
    challenge:
      "쓰던 복합기가 오래돼 인쇄가 잘 되지 않고 고장이 잦았습니다. 저렴한 기종만 보고 고르면 사무 환경에 맞지 않아 오히려 업무가 느려집니다. 그래서 인쇄 속도와 사용량에 맞는 선택이 필요했습니다.",
    solution: [
  ...
  },
  {
    ...
    challenge:
      "복합기를 고를 때 사무실 크기만 보고 정하는 경우가 많습니다. 정작 중요한 건 한 번에 얼마나 인쇄하느냐죠. 인쇄량이 적은데 빠른 기종을 넣으면 돈만 더 드는 구조라 사용량 파악이 먼저였습니다.",
    solution: [
  ...
  },
  {
    ...
    challenge:
      "작은 사무실이면 프린터 정도로 충분하지 않냐는 질문을 많이 받습니다. 이곳은 처음부터 인쇄를 많이 하는 편이라고 말씀해 주셨고요. 인쇄량이 많으면 속도와 토너 용량을 받쳐 주는 기종이 필요합니다.",
    solution: [
  ...
  },
  {
    ...
    summary:
      "한 곳은 마모된 부품을 현장에서 바로 교체. 다른 곳은 정부조달 제품인 TASKalfa 4012iG를 넣은 현장.",
    ...
    challenge:
      "설치 전 점검에서 내부 부품에 마모 흔적이 보였습니다. 롤러나 토너 쪽은 평소에도 잔고장이 잦은 부위. 인쇄량이 많은 곳에서는 고장 한 번에 업무 전체가 멈춥니다.",
    solution: [
  ...
  },
  {
    ...
    solution: [
      ...
      "3단계 구성 제안 - PC는 예산 안, 프린터는 월 출력량 기준 렌탈, NAS는 인원·용량에 맞는 라인업",
      "4단계 설치 - PC 설치, 프린터 네트워크 연결, NAS 초기 설정과 백업 스케줄까지 한 번의 방문으로",
    ],
    result:
      "장비를 따로따로 놓는 것이 아니라 하나의 흐름으로 맞췄습니다. 이 PC로 이 프린터를 어떻게 쓸지, 이 NAS에 어떤 자료를 백업할지까지. 반복 백업이나 파일 정리를 자동화하는 방향도 함께 안내했지만, 필요 여부부터 같이 확인하는 편입니다.",
    spec: [
  ...
  },
  {
    ...
    challenge:
      "현장 일과 프로젝트를 함께 수행해 보고와 발표가 잦은 곳이었습니다. 정부 사업처럼 규모가 큰 일은 보고가 계속 이어집니다. 그런데 빔프로젝터는 잠깐 쓰고 마는 장비라 구매까지는 망설여진다고 하셨습니다.",
    solution: [
