...
const supportFaq = [
  ...
  },
  {
    ...
    a: "본사가 대구광역시 달서구 문화회관11안길에 있습니다. 달서구·성서공단은 가장 빠르게 움직여요. 대구 전역과 경상북도는 당일 방문, 영남권은 협의 방문, 전국은 1영업일 대응. 원격으로 되는 증상은 방문 없이 그 자리에서 처리합니다.",
  },
  {
...
const serviceJsonLd = serviceLd({
  ...
  description:
    "컴퓨터·복합기·NAS·네트워크를 한 회사가 통합 관리하는 올인원 전산 유지보수. 원격지원, 출장 수리, AS 접수, 토너·소모품 공급, 무료 방문 견적. 관리 고객사 200곳 이상, 대구·경북 당일 방문.",
});
  ...
  return (
    <>
      ...
      <AnswerBlock
        ...
        answer="한별시스템은 대구광역시 달서구에 있는 기업 전산 올인원 관리 업체로, 현재 200곳 이상의 고객사를 관리하고 있습니다. 컴퓨터 수리, 프린터·복합기 출장 수리, NAS 서버, 사무실 네트워크, 홈페이지까지 한 업체가 맡기 때문에 어디가 고장인지 고객이 구분할 필요가 없습니다. 달서구·성서공단을 포함한 대구 전역과 경상북도는 당일 방문하며, 전화 한 통(053-588-7119)이면 원격 진단부터 시작합니다."
        facts={[
          { label: "관리 고객사", value: "200곳 이상" },
