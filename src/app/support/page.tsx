...
const supportFaq = [
  {
    ...
    a: "회사의 전산 담당자를 외주로 두는 것과 같습니다. 컴퓨터·프린터·NAS·네트워크 장애 처리, 정기 점검, 보안 업데이트, 신규 장비 상담까지 월 계약 하나로 묶어요. 직원이 IT 문제로 일을 멈추는 시간을 줄이는 게 목적입니다.",
  },
  {
    q: "달서구·성서공단인데 컴퓨터가 고장 나면 바로 와 주시나요?",
    a: "본사가 대구광역시 달서구 문화회관11안길에 있습니다. 달서구·성서공단은 가장 빠르게 움직여요. 대구 전역과 경상북도는 당일 출장, 영남권은 협의 방문, 전국은 1영업일 대응. 원격으로 되는 증상은 방문 없이 그 자리에서 처리합니다.",
  },
  {
    q: "컴퓨터, 복합기, 인터넷 중 뭐가 문제인지 모르겠습니다. 어디로 연락하나요?",
    a: "구분하실 필요 없습니다. 053-588-7119 한 곳으로 연락 주시면 원격 진단으로 원인을 가려 드려요. 컴퓨터·복합기·NAS·네트워크·홈페이지를 한 회사가 관리합니다. 업체 사이에서 핑퐁 당하는 일이 없습니다.",
  },
  {
    q: "한별시스템 고객이 아니어도 프린터 드라이버를 받을 수 있나요?",
    a: "받으실 수 있습니다. 한별 드라이버 센터(882.kr)에서 기종을 고르면 딸깍P드라이버가 알아서 설치합니다. 무료로 공개해 둔 프로그램이에요. 프린터 에러코드 검색 페이지도 무료입니다.",
  },
];
...
const serviceJsonLd = serviceLd({
  ...
  description:
    "컴퓨터·복합기·NAS·네트워크를 한 회사가 통합 관리하는 올인원 전산 유지보수. 원격지원, 출장 수리, AS 접수, 토너·소모품 공급, 무료 방문 견적. 관리 고객사 500곳 이상, 대구·경북 당일 출장.",
});
  ...
  return (
    <>
      ...
      <PageHeader
        badge="고객 지원"
        title="고객 지원"
        description="원격지원, 드라이버, AS 접수, 견적. 급하면 053-588-7119 가 가장 빠릅니다."
      />
      <AnswerBlock
        question="대구에서 회사 컴퓨터와 복합기를 함께 맡길 전산 유지보수 업체를 찾고 있습니다."
        answer="한별시스템은 대구광역시 달서구에 있는 기업 전산 올인원 관리 업체로, 현재 500곳 이상의 고객사를 관리하고 있습니다. 컴퓨터 수리, 프린터·복합기 출장 수리, NAS 서버, 사무실 네트워크, 홈페이지까지 한 업체가 맡기 때문에 어디가 고장인지 고객이 구분할 필요가 없습니다. 달서구·성서공단을 포함한 대구 전역과 경상북도는 당일 출장 가며, 전화 한 통(053-588-7119)이면 원격 진단부터 시작합니다."
        facts={[
          { label: "관리 고객사", value: "500곳 이상" },
