...
const sections: { h: string; p: string[] }[] = [
  ...
  },
  {
    ...
    p: [
      "회사 웹사이트는 방문 통계를 보려고 구글 애널리틱스(Google Analytics 4)를 씁니다. 쿠키로 모으는 정보는 아래와 같습니다.\n- 방문한 페이지와 머문 시간\n- 들어온 경로(검색, 다른 사이트의 링크)\n- 기기·브라우저 종류와 도시 단위의 대략적인 지역\n- 전화·견적·원격지원 버튼을 누른 기록",
      "이름이나 연락처는 보내지 않습니다. 구글 애널리틱스4는 IP 주소를 기록하거나 저장하지 않습니다. 모은 통계를 쓰는 곳은 한 가지, 문의가 막히는 화면을 찾아 고치는 일.",
      "쿠키 저장을 거부하려면 아래 둘 중 하나를 하면 됩니다.\n- 브라우저 설정에서 쿠키 차단\n- 구글 차단 부가기능 설치(tools.google.com/dlpage/gaoptout)\n쿠키를 막아도 웹사이트는 그대로 이용할 수 있습니다.",
      "기기에만 남는 편의 정보도 있습니다.\n- 다크모드 설정\n- AI 상담 창의 대화 기록\n이 정보는 회사로 보내지 않고, 브라우저 설정에서 언제든 지울 수 있어 이용자가 직접 관리합니다.",
    ],
  },
  {
    h: "10. 개인정보 보호책임자",
