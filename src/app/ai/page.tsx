...
const faq = [
  {
    ...
    a: "질문에 답하는 AI 모델을 외부 회사 서버가 아니라 우리 회사 NAS 안에서 돌리는 것입니다. 챗GPT는 질문과 붙여 넣은 자료가 외부 서버로 갑니다. 사내 AI는 그 자료가 사무실 네트워크 밖으로 나가지 않아요. 대신 회사 장비 성능만큼만 똑똑합니다. 그래서 창작이나 복잡한 추론보다 사내 문서를 찾아 요약하는 일에 맞습니다.",
  },
  {
    q: "한별시스템은 이걸 실제로 해 본 적이 있나요?",
    a: "자사 NAS에서 직접 운영하고 있습니다. Ryzen V1500B에 RAM 4GB인 NAS 한 대에 로컬 LLM 컨테이너를 올렸어요. 사내 관리 데이터를 검색·질의하는 AI 도우미를 2026년 8월 3일부터 돌리고 있습니다. 소형 모델 기준 질문당 7초에서 60초 사이에 답합니다. 파는 물건을 저희가 먼저 쓰고 있습니다.",
  },
  {
    q: "NAS만 있으면 바로 되나요? 추가 비용은요?",
    a: "지금 쓰시는 NAS 사양에 따라 다릅니다. 문서를 찾아 주는 1단계는 기존 NAS로도 시작할 수 있어요. 사내 전용 AI 서버로 쓰려면 RAM 증설과 SSD 캐시가 필요합니다. 저희 실측으로 RAM 4GB에서 소형 모델 하나가 상주 메모리 약 2.1GB를 씁니다. 다른 서비스와 같이 돌리려면 증설이 사실상 필수. 현장을 보고 지금 장비로 되는지부터 말씀드립니다.",
  },
  {
    q: "소형 모델이면 답이 부정확하지 않나요?",
    a: "부정확할 수 있습니다. 저희 운영 기록에도 소형 모델이 숫자 계산을 간헐적으로 틀린 사례가 있어요. 그래서 화면에 참고용이라는 안내를 띄우고 원본을 함께 보여 줍니다. 사내 AI는 사람을 대체하는 도구가 아닙니다. 자료를 빨리 찾아 주는 도구로 잡는 편이 현실적입니다.",
  },
  {
    q: "우리 회사에 지금 필요한지 어떻게 판단하나요?",
    a: "방문해서 자료가 어디에 얼마나 쌓여 있는지부터 봅니다. 직원들이 무엇을 못 찾아 헤매는지도 같이 봐요. 보고 나서 필요 없으면 필요 없다고 말씀드립니다. 직원 5명 이하이고 문서가 많지 않은 곳에는 백업부터 제대로 잡으시라고 권합니다. 상담과 방문 견적은 무료입니다.",
  },
];
