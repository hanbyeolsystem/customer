...
const INTRO: Record<string, { title: string; desc: string; answer: string; facts: { label: string; value: string }[] }> = {
  ...
  pc: {
    ...
    answer: "사무용 PC는 하는 일에 맞는 사양이면 충분하고 무조건 고사양은 돈만 더 듭니다. 데스크탑과 모니터 세트는 월 40,000원부터(데스크탑 35,000원 + 모니터 5,000원, VAT 별도) 임대할 수 있고 AS가 포함됩니다. PC가 느린 원인이 PC가 아니라 네트워크인 경우가 많아 한별시스템은 원격으로 먼저 원인을 좁힌 뒤 방문합니다. 컴퓨터·복합기·NAS·네트워크를 한 회사가 관리해 관리 고객사 200곳 이상을 운영하고 있습니다.",
    facts: [{ label: "PC+모니터", value: "월 4만원부터" }, { label: "관리 고객사", value: "200곳 이상" }, { label: "대응", value: "원격 우선" }, { label: "대구·경북", value: "당일 방문" }],
  },
  network: {
    title: "네트워크·인터넷 Q&A",
