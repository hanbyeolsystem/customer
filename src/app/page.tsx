...
export const metadata: Metadata = {
  title: { absolute: "한별시스템 - 대구 NAS 구축·복합기 렌탈·전산 유지관리" },
  description:
    "대구광역시 달서구 한별시스템. 2008년부터 19년간 대구·경북 기업의 나스(NAS) 구축, 복합기·프린터 렌탈, 컴퓨터 수리와 전산 유지관리를 한 회사에서 맡아 왔습니다. 관리 고객사 170곳, 무료 방문 견적 053-588-7119.",
