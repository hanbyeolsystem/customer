  ...
  return (
    <>
      ...
      <AnswerBlock
        ...
        answer={`회원가입 없이 닉네임만으로 NAS·백업·복사기·컴퓨터·네트워크 질문을 남기면 한별시스템 엔지니어가 직접 답하는 게시판입니다. 현재 질문 ${questions.length}개 중 ${answered}개에 답변이 달려 있고, 답변은 일반적인 안내이며 실제 조치는 현장 확인 후 이루어집니다. 급한 장애는 ${site.phone.main}로 전화 주시면 대구·경북은 당일 출장 갑니다. 자주 나오는 질문 ${"256"}가지는 Q&A 페이지에 개별 답변으로 정리되어 있습니다.`}
        facts={[
