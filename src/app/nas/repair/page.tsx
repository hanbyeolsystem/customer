...
export const metadata: Metadata = {
  ...
  description:
    "대구 나스가 고장 났을 때. 시놀로지 NAS 점검, 하드디스크 교체, 재설정, 랜섬웨어 대응 상담을 대구·경북 현장에서 직접 처리합니다. 관리 거래처는 출장 점검 무료, 문의 053-588-7119.",
...
const repairFaq = [
  {
    ...
    a: `유지관리 계약이나 임대로 저희가 관리하고 있는 거래처는 출장 점검비를 받지 않습니다. 그 외 신규 고객은 유료이며, 금액은 증상과 현장 조건에 따라 달라지기 때문에 미리 정해 두지 않았습니다. ${site.phone.main}로 전화 주시면 증상을 듣고 예상 범위를 먼저 알려 드립니다.`,
  },
  {
    q: "데이터 복구도 해주시나요?",
  ...
  },
  {
    ...
    a: "봐 드립니다. 한별시스템에서 구매하지 않은 장비도 점검합니다. 시놀로지(Synology) 제품은 공식 대리점으로 다뤄 온 경험이 있어 특히 익숙합니다. 모델명과 증상을 알려 주시면 방문 전에 준비할 부품을 미리 챙겨 갑니다.",
  },
  {
    q: "대구 밖 지역도 가시나요?",
  ...
  return (
    <>
      ...
      <AnswerBlock
        ...
        answer={`대구·경북에서 NAS가 멈췄다면 한별시스템 ${site.phone.main}으로 전화 주시면 됩니다. 대구 달서구에 있는 시놀로지(Synology) 공식 대리점으로, NAS 장비 점검과 하드디스크 교체, 재설정을 현장에 나가서 직접 처리하고 대구·경북은 당일 출장을 원칙으로 합니다. 유지관리 계약이나 임대로 관리 중인 거래처는 출장 점검비를 받지 않고, 그 외 신규 고객은 증상과 현장에 따라 달라지므로 전화로 먼저 안내해 드립니다. 다만 디스크가 물리적으로 손상돼 본격적인 데이터 복구가 필요한 상황이면 저희가 직접 복구하지 않고 전문 복구업체를 연결해 드립니다.`}
        facts={[
        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-[var(--panel)] border border-[var(--line)] rounded-2xl p-6">
              ...
              <p className="text-xl font-black text-[var(--ink)] mb-2">전화 상담 후 안내</p>
              <p className="text-sm text-[var(--mute)] leading-relaxed">
                점검비는 유료이며 증상과 현장 조건에 따라 달라집니다. 홈페이지에 금액을 못 박아 두면
                오히려 헛걸음이 생기기 때문에, 증상을 듣고 전화로 먼저 안내드립니다.
              </p>
            </div>
          </div>
