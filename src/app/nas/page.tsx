...
const nasFaq = [
  ...
  {
    q: "구축한 뒤 관리는 누가 하나요?",
    a: "한별시스템이 분기 점검, 시스템(DSM) 보안 패치, 디스크 상태(SMART) 모니터링까지 운영을 맡습니다. 대구·경북 기업 중심으로 100건 이상의 NAS를 구축했고 19년째 기업 IT를 관리하고 있습니다.",
  },
];

export const metadata: Metadata = {
  title: "대구 NAS 구축 - 기업용 나스·데이터 백업",
  description: "대구 나스(NAS) 구축 전문. 시놀로지 공식 대리점으로 기업용 NAS 100건 이상 구축. RAID 설계·3-2-1 백업·랜섬웨어 대응·VPN 원격접속까지. 대구·경북 당일 방문, 무료 견적.",
  ...
  return (
    <>
      ...
      <AnswerBlock
        ...
        answer="한별시스템은 대구광역시 달서구에 있는 시놀로지(Synology) 공식 대리점으로, 기업용 나스(NAS, 네트워크 저장장치)를 판매·구축하는 대구 나스 업체입니다(구축 실적 100건 이상). 정품 장비 판매와 납품에 그치지 않고 RAID 설계, 3-2-1 백업 구성, 랜섬웨어 대비 스냅샷, VPN 원격접속 설정, 직원 사용 교육까지 현장에서 진행합니다. 대구·경북은 당일 방문해 현장을 직접 보고 무료로 견적을 냅니다."
        facts={[
