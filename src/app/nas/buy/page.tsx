    ...
    <>
      ...
      <section className="py-14 lg:py-20 bg-[var(--bg)]">
        <div className="max-w-5xl mx-auto px-4 lg:px-6">
          ...
          {/* 네이버 스마트스토어 안내(2026-09-26). 스토어 가격 표기와 이 페이지(VAT 별도)가 부딪히지 않게 금액은 적지 않는다. */}
          <div className="mt-10 rounded-md border border-[var(--line)] bg-[var(--panel)] p-5 lg:p-6">
            ...
            <div className="flex flex-wrap gap-2.5">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center justify-center h-11 px-5 rounded-md bg-[var(--ink)] text-[var(--bg)] font-bold text-[14px] hover:bg-hb-blue transition"
              >
                스마트스토어 알림받기
              </a>
              <a
