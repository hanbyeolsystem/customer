...
const serviceCatalog = [
  ...
  { id: serviceId("/nas/"), url: `${site.url}/nas/`, name: "기업용 NAS 구축·데이터 백업", alt: ["대구 나스 구축", "대구 NAS 설치", "대구 나스 업체"], desc: "시놀로지 NAS 설치, RAID 설계, 3-2-1 백업 구성, 랜섬웨어 대비, VPN 원격접속. 구축 실적 50개사 이상(네트워크 공사·백업 구축과 같은 현장 기준)." },
