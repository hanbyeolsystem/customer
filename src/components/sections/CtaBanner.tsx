    ...
    <section className="py-16 lg:py-20 bg-[var(--bg)]">
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        <div className="relative overflow-hidden rounded-3xl bg-hb-primary text-white p-10 lg:p-16 text-center shadow-2xl">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(242,165,22,0.18),transparent_55%)]" />
          <div className="relative">
            ...
            <h2 className="text-2xl lg:text-4xl font-black tracking-tight mb-3 leading-tight">
              지금 시스템 점검, <span className="text-hb-gold">한별</span>과 시작하세요
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md sm:max-w-none mx-auto">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-hb-gold hover:bg-hb-gold-2 text-hb-primary font-extrabold text-base lg:text-lg px-8 py-4 rounded-xl transition shadow-lg shadow-hb-gold/25"
              >
